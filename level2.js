...
GAME.level2 = new GAME.Level({  
    ...
    for (var i = 0; i < 50; i ++) {
        ...
        var platY = -200 + i *5 + 30*i*Math.random();
        GAME.platforms.push(new GAME.Platform({ x:platX, y:platY, z:0, width:100, height:40, color:0xFFFFFF, depth:100, threeD:true  }));
